...
NGame = {
	...
	HANDS_OFF_START_TAG = "TST",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
...
NProduction = {
	...
	BASE_FACTORY_SPEED = 5, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives). TODO NOTE FOR GLORWYN - this can make dockyards more powerful
...
NAI = {
	...
	DEFAULT_SUPPLY_TRUCK_BUFFER_RATIO = 1.25,	-- ai will set to truck buffer ratio to this. can be modified by wanted_supply_trucks min_wanted_supply_trucks ai strats
	...
	STR_UNIT_NORMAL = 0.60,						-- Strength (equipment) % for unit to be considered normal
	...
	WANTED_UNITS_MANPOWER_DIVISOR = 100000,                     -- Normalizing divisor for AI manpower. (below this they will be careful making more divisions, above they want more)
	...
	MAX_MICRO_ATTACKS_PER_ORDER = 6,					-- AI goes through its orders and checks if there are situations to take advantage of
	...
	LAND_DEFENSE_AIR_SUPERIORITY_IMPORTANCE = 0.40,		-- Strategic importance of air superiority ( amount of enemy planes in area )
	...
	LAND_DEFENSE_SUPPLY_HUB_IMPORTANCE = 10,             -- Strategic importance of supply hubs
	...
	LAND_COMBAT_CAS_WINGS_PER_ENEMY_ARMY_LIMIT = 8,		-- Limit of CAS wings requested by enemy armies
	LAND_COMBAT_CAS_PER_ENEMY_ARMY = 20,				-- Amount of CAS planes requested per enemy army
	LAND_COMBAT_ANTI_LOGISTICS_PER_ENEMY_ARMY = 1,     -- Amount of CAS planes requested per enemy army for anti-logistics
	...
	LAND_COMBAT_INTERCEPT_PER_PLANE = 0.8,				-- Amount of interception planes requested per enemy plane
	...
	REASSIGN_TO_ANOTHER_FRONT_FACTOR = 0.4,                    -- Factor for reassigning to another front. 0.0 < X < 1.0 means reluctant, X > 1.0 means want to.
	...
	MANPOWER_RATIO_CAREFULNESS_THRESHOLD = 0.20,                -- if manpower ratio (available/used-by-army) is less than this, start being more careful with plan execution (i.e. don't throw your men into the meat grinder if you're running out of manpower)
	...
	FIELDED_EQUIPMENT_BUFFER_RATIO_FOR_OCCUPATION_AI = 0.2, -- garrison ai will try to leave this ratio of buffers while assigning laws
	FIELDED_MANPOWER_BUFFER_RATIO_FOR_OCCUPATION_AI = 0.1,  -- garrison ai will try to leave this ratio of buffers while assigning laws
	...
	MAX_AVAILABLE_MANPOWER_RATIO_TO_BUFFER_WARTIME = 0.3,			-- deployment will try to buffer a ratio of manpower (for reinforcements) during war time
